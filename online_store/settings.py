...
SECRET_KEY = '^7q*r&nn=-)ec7-3jc&z(x2*23x@3@ua7u)0z%snc&oo3elk&o'
...
# 配置自定义类
# REST_FRAMEWORK = {
# 	'DEFAULT_PAGINATION_CLASS': 'online_store.apps.core.pagination.GoodsPaginator',
# 	'PAGE_SIZE': 100
# }
